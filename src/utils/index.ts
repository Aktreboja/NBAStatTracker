...
export const retrievePlayerInformation = async (firstName: string, lastName: string) : Promise<PlayerInfo | Object>  => {
    const bdlResponse : BdlPlayer[] = await getPlayerByFullName(firstName, lastName);
